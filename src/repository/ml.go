...
`
	summaryUserPrompt = `
Суммаризируй следующие новости и оставь только важное, не больше 2500 символов.
Вот правила:
- Вывод должен содержать только краткое содержание новостей.
- Ответ должен быть на русском языке.
- Сформулируй не более 10 основных пунктов, выбирая самое важное.
- Связанные новости объединяй в один пункт.
- Каждый пункт начинай с 🔸.
- Не используй другие символы, кроме 🔸.
...
… и так далее от 7 до 10 основных пунктов.
`
)
