...
//
//	mockgen -source=summary.go -destination=../mocks/summary_mock.go -package=summary_mock
//

// Package summary_mock is a generated GoMock package.
package summary_mock
